...
<body>
    ...
    <div dir="rtl">
        ...
        <p dir="rtl"
            ...
            <strong><span style="font-family:'Simplified Arabic'; color:#ffffff;">تقرير تقييم المدرِّبين في برنامج
                ...
                <tbody>
                    <tr style="height:13.1pt;">
                        ...
                        <td
                            ...
                            <p dir="rtl"
                                ...
                                <strong><span style="font-family:'Simplified Arabic';">{{$course->field}}&nbsp;</span></strong></p>
                        </td>
                        <td
                    ...
                    <tr style="height:11.05pt;">
                        <td
                            ...
                            <p dir="rtl"
                                style="margin-top:0pt; margin-bottom:0pt; text-align:center; line-height:108%; font-size:11pt;height: 16pt">
                                <strong><span style="font-family:'Simplified Arabic';">اسم البرنامج التدريبي</span></strong>
                            </p>
                        </td>
                        <td
        ...
        <div dir="rtl" style="text-align:center;">
            <table cellspacing="0" cellpadding="0"
            style="width:750.25pt; margin-right:auto; margin-left:auto; border:1pt solid #000000; border-collapse:collapse;">
            <tbody>
                    <tr>
                        <td rowspan="2"
                        ...
                        <td rowspan="2"
                            ...
                            <p dir="rtl" style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:10pt;">
                                <strong><u><span style="font-family:'Simplified Arabic';">اسم المدرب</span></u></strong></p>
                        </td>
                        <td rowspan="2"
                                ...
                                <td
                                    ...
                                    <p dir="rtl" style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:10pt;">
                                        <strong><span style="font-family:'Simplified Arabic';">&nbsp;</span></strong><strong><span
                                                style="font-family:'Simplified Arabic';">{{$item[2] ?? '-'}}&nbsp;</span></strong></p>
                                </td>
                                <td
