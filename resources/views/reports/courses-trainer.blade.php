...
<body>
    ...
    <div dir="rtl">
        ...
        <p dir="rtl"
            ...
            <strong><span style="font-family:'Simplified Arabic'; color:#ffffff;">تقرير تقييم مدرب في مجموعة برامج تدريبية 
                    </span></strong></p>
        <p dir="rtl"
                    ...
                    <tr style="height:13.1pt;">
                        <td
                            ...
                            <p dir="rtl"
                                ...
                                <strong><span style="font-family:'Simplified Arabic';">اسم المدرب</span></strong></p>
                        </td>
                        <td
                        ...
                        <td
                            ...
                            <p dir="rtl"
                                style="margin-top:0pt; margin-bottom:0pt; text-align:center; line-height:108%; font-size:11pt;">
                                <strong><span style="font-family:'Simplified Arabic';">المجال التدريبي</span></strong>
                            </p>
                        </td>
                        <td
        ...
        <div dir="rtl" style="text-align:center;">
            ...
            <tbody>
                    <tr>
                        ...
                        <td rowspan="2"
                            style="width:120pt; border-right-style:solid; border-right-width:1pt; border-left-style:solid; border-left-width:1pt; border-bottom-style:solid; border-bottom-width:1pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:middle; background-color:#deebf6;">
                            <p dir="rtl" style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:10pt;">
                                <strong><u><span style="font-family:'Simplified Arabic';">البرنامج التدريبي</span></u></strong></p>
                        </td>
                        <td rowspan="2"
                            style="width:20pt; border-right-style:solid; border-right-width:1pt; border-left-style:solid; border-left-width:1pt; border-bottom-style:solid; border-bottom-width:1pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:middle; background-color:#deebf6;">
                            <p dir="rtl" style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:10pt;">
                                <strong><u><span style="font-family:'Simplified Arabic';">مكان انعقاد البرنامج</span></u></strong></p>
                        </td>
                        <td rowspan="2"
                        ...
                        <td colspan="1" rowspan="2"
                            style="width:60.4pt; border-right-style:solid; border-right-width:1pt; border-left-style:solid; border-left-width:1pt; border-bottom-style:solid; border-bottom-width:1pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:middle; background-color:#deebf6;">
                            <p dir="rtl" style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:10pt;">
                                <strong><u><span style="font-family:'Simplified Arabic';">تاريخ التنفيذ</span></u></strong>
                            </p>
                        </td>
                        <td colspan="5"
                        ...
                        <td rowspan="2"
                            style="width:20.65pt; height:0pt; margin-right:auto; margin-left:auto; writing-mode:tb-rl; border-style:solid; border-width:1pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:middle; background-color:#deebf6; -moz-transform:rotate(180deg); -ms-transform:rotate(180deg); overflow:hidden; transform:rotate(180deg); -webkit-transform:rotate(180deg);">
                            <div
                                style="height:0pt; margin-right:auto; margin-left:auto; writing-mode:tb-rl;margin-left: -15px;margin-right: -15px;">
                                <p dir="rtl" style="margin:65pt 5.65pt; text-align:center; font-size:10pt;"><strong><u><span
                        ...
                        @foreach ($myArray as $key=>$item)     
                            <tr>
                                ...
                                <td
                                    ...
                                    <p dir="rtl" style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:10pt;"><span
                                            style="font-family:'Simplified Arabic';">{{number_format((array_sum($item[4])/count($item[4])), 1, '.', ',')}}&nbsp;</span></p>
                                </td>
                            </tr>
                         @endforeach
                    @endif
