...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="{{route('dashboard')}}">
            <img alt="Logo" src="{{asset('admin/media/logos/loooog.png')}}" class="h-60px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="menu-link active" href="{{route('dashboard')}}">
                        ...
                        <span class="menu-title">الإفتراضية</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('trainers.index')}}">
                        ...
                        <span class="menu-title">المدربون</span>
                    </a>
                </div>  
                <div class="menu-item">
                    <a class="menu-link" href="{{route('trainees.index')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">المتدربون</span>
                    </a>
                </div>    
                <div class="menu-item">
               ...
               {{--  <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="javascript:void(0)">
                                        ...
                                        <span class="menu-title">عرض الدور</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('home')}}">
                        ...
                        <span class="menu-title">صفحة الهبوط</span>
                    </a>
                    <div class= "text-center pt-5 mt-5">
                        <div >
                            <h5 class="text-muted py-3">اسم الادمن : {{Auth()->user()->name}}</h5>
                        </div>
                        <div >
                            <img src="{{$trimmedUrl}}" alt="user" class = "rounded-circle"/>
                        </div>
                    </div>
                </div> 
            </div>
